  ...
  return (
    <div id="testimonials" className="min-h-screen bg-[#1A1A1A] flex flex-col relative pt-16 md:pt-0">
      ...
      <div className="flex flex-col md:flex-row px-4 sm:px-6 md:px-16 mt-2 md:mt-6 flex-1 pb-4 md:pb-16 z-10">
        {/* Left section */}
        <div className="w-full md:w-[55%] mb-4 md:mb-0 pr-0 md:pr-4 order-1 md:order-none max-w-[720px]">
          ...
          <div className="border-l border-gray-700 pl-3 sm:pl-4 md:pl-6 lg:pl-8 mt-3 md:mt-3 lg:mt-8 space-y-3 md:space-y-6 lg:space-y-6 nest-hub-testimonials">
            <div>
              ...
              <p className="text-white w-full mb-1 sm:mb-2 md:mb-2 lg:mb-3 text-sm md:text-sm lg:text-sm xl:text-base leading-relaxed">
        ...
        <div className="w-full md:w-full lg:w-[45%] mt-8 md:mt-16 flex flex-col items-center justify-center md:justify-end lg:justify-start relative order-2 md:order-none lg:pl-8 lg:ml-auto">
          <div className="text-center flex flex-col items-center gap-4 w-full md:items-center lg:items-end lg:text-center">
            <p className="text-[#23F972] text-base sm:text-[1.4rem] md:text-[1rem] lg:text-[1rem] xl:text-[1.3rem] leading-relaxed font-arial text-center lg:text-[1.5rem]">
      ...
      <div className="absolute right-0 bottom-0 overflow-visible pointer-events-none hidden md:block z-[5]">
        <Image
          ...
          width={1920}
          height={1080}
          className="w-[800px] md:w-[900px] lg:w-[1200px] xl:w-[1400px] 2xl:w-[1600px] h-auto object-contain"
          style={{
            marginBottom: "4px",
            marginRight: "-24px",
          }}
