  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#0A3B2E]">
      ...
      <div className="flex px-16 mt-16">
        ...
        <div className="w-[45%]">
          {/* Title */}
          <div className={`flex flex-col font-chameleon ml-{-5} mt-25 font-bold`} >
          ...
          {/* Subtitle */}
          <div className="ml-65 mt-12 space-y-6">
        ...
        {/* Right Content */}
        <div className="w-[25%] mt-35  flex flex-col items-end pt-50" style={{fontFamily: 'Arial-Regular'}}>
          <p className={`text-[#1EEB7A] text-2xl text-right mb-4 `} style={{fontFamily: 'Arial-Regular'}}>
